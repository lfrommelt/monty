...
\note{\begin{block}{How to use PINGO?}
...
\begin{frame}[fragile,fragile]{Data types in this lecture}
...
\note{In the following weeks, you will get to know more data types like
